...
**在哪执行**：`scripts/ops/forecast_snapshot.py`（record/score，表 `$IRA_RUNTIME_ROOT/stores/relational/ira.db::forecast_events`）。测试 `tests/test_forecast_snapshot.py`。README「forecast_events」。
