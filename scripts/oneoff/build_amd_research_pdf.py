...
OUT = _SETTINGS.artifact_root / "pdf"
TMP = _SETTINGS.cache_root / "amd_report"
...
def build():
    ...
    st += [
        ...
        callout(
            "投资结论",
            "中性 / 观察。基准合理价值465美元，合理区间430-530美元；当前价格484.64美元，市场已计入相当部分2027年MI450与EPYC增长。",
        ),
        Spacer(1, 0.17 * inch),
        P("基准日：2026年8月4日（AMD 2026Q2财报发布前）", S["center"]),
        P(
            "当前价格：484.64美元　|　市值：约7,997亿美元　|　未来12个月核心事件：MI450量产与Helios机架交付",
            S["center"],
        ),
        Spacer(1, 0.25 * inch),
        h2("核心观点"),
        ...
        body(
            "<b>主要分歧：</b>GW协议代表多年期潜在需求，不等于当期确认收入；权证、战略投资与客户集中降低每股价值确定性。"
        ),
        body(
            "<b>估值判断：</b>只有在2027年收入接近1,000亿美元、摊薄后EPS接近18美元时，600美元以上目标才成立。"
        ),
        source(
            "AMD公司公告、AMD 2026Q1财务报告、AMD Advancing AI 2026、UBS（2026-06-24）、公开市场数据；本报告测算。"
        ),
        PageBreak(),
    ]
    ...
    st += [
        ...
        callout(
            "一句话结论",
            "AMD的第二供应链地位正在得到客户合同验证，但当前股价交易的是2027年而不是2026年；应把MI450交付和权证摊薄同时纳入估值。",
        ...
        table(
            ...
            [2.35 * inch, 1.02 * inch, 1.02 * inch, 1.02 * inch, 1.02 * inch],
            font=7.8,
        ),
        source("摊薄股数为研究情景，不代表权证一定全部归属；2025A EPS采用可比口径。"),
        h2("投资逻辑的三层证据"),
        body(
            "<b>第一层｜CPU份额与ASP。</b>EPYC受益于核心数、能效与x86兼容性。Agentic AI提高控制面、检索、数据处理和传统软件负载，CPU有独立增量。"
        ),
        body(
            "<b>第二层｜GPU与机架。</b>OpenAI、Meta、Anthropic及微软的合作把MI450从产品路线图推进到部署阶段。真正决定收入的是机架价值、交付节奏和验收。"
        ),
        body(
            "<b>第三层｜开放软件。</b>ROCm与Coding Agent降低迁移成本，但生产稳定性、算子覆盖、多机通信和工具仍需验证。"
        ),
        h2("最关键的跟踪变量"),
        table(
            [
            ...
            [1.15 * inch, 1.8 * inch, 1.75 * inch, 1.73 * inch],
            font=6.9,
        ),
        PageBreak(),
    ]
    ...
    # Page 3
    st += [
        h1("2. 公司定位：从芯片组合走向异构系统"),
        body(
            "AMD的竞争方式不是复制英伟达的单一GPU优势，而是用EPYC CPU、Instinct GPU、Pensando NIC/DPU、Helios机架与ROCm软件形成可组合的平台。该组合对希望降低单一供应商依赖的云厂商尤其有吸引力。"
        ),
        table(
            [
                ["层级", "核心产品", "客户价值", "核心验证点"],
            ...
            [1.08 * inch, 1.78 * inch, 1.9 * inch, 1.67 * inch],
            font=7.1,
        ),
        ...
        table(
            ...
            [1.05 * inch, 1.75 * inch, 1.95 * inch, 1.68 * inch],
            font=7.1,
        ),
        h2("TAM可以扩大，但不能替代份额模型"),
        body(
            "AMD给出的2030年AI芯片TAM约1.4万亿美元、数据中心CPU TAM约2,200亿美元，说明行业空间足够大；但TAM不是收入预测。模型仍需回答单位份额、ASP、机架价值量和确认时点。"
        ),
        callout(
            "判断",
            "“市场足够大”只解决天花板；“客户何时验收、AMD确认多少收入、付出多少稀释和投资”才决定每股价值。",
    ...
    st += [
        ...
        table(
            ...
            [0.75 * inch, 0.85 * inch, 1.35 * inch, 1.75 * inch, 1.73 * inch],
            font=6.4,
        ),
        source("AMD关于OpenAI、Meta、Anthropic、Microsoft和Oracle的官方公告；规模均为潜在/计划部署口径。"),
        h2("为什么不能用“美元/GW”直接乘"),
        body(
            "一个GW可对应不同GPU数量、功耗配置、网络方案与系统边界。若AMD只确认GPU和部分网络收入，价值量较低、毛利率较高；若确认完整机架收入，收入更高但包含更多低毛利率部件。收入和毛利率必须成对假设。"
        ),
        table(
            [
            ...
            [1.25 * inch, 1.05 * inch, 1.15 * inch, 2.98 * inch],
            font=7.2,
        ),
        h2("客户集中与信用链条"),
        body(
            "OpenAI与Meta潜在规模足以改变AMD收入结构，也提高单一客户、融资和项目节奏风险。对NeoCloud伙伴的投资或担保有助于形成需求，但会把供应商风险扩展为投资、信用和回收风险。"
        ),
        h2("研究模型的处理原则"),
        body(
            "1）2026只计入可在H2交付并验收的部分；2）多年期GW按2027-2030分期；3）完整系统收入与毛利率不同时采用最乐观假设；4）权证与战略投资从每股价值和现金用途两端处理。"
        ),
        PageBreak(),
    ]
    ...
    st += [
        ...
        table(
            ...
            [1.55 * inch, 1.45 * inch, 3.43 * inch],
            font=7.4,
        ),
        callout(
            "关键差异",
            "本报告没有把首批GW“开始出货”解释为当年完整部署；2026收入主要由现有MI350、EPYC增长和MI450首批贡献构成。",
            colors.HexColor("#E8F3F1"),
            TEAL,
        ),
        h2("分部收入基准情景"),
        table(
            ...
            [0.95 * inch, 0.67 * inch, 0.67 * inch, 0.67 * inch, 0.67 * inch, 2.80 * inch],
            font=6.9,
        ),
        PageBreak(),
    ]
    ...
    st += [
        ...
        table(
            ...
            [2.2 * inch, 1.06 * inch, 1.06 * inch, 1.06 * inch, 1.05 * inch],
            font=7.4,
        ),
        source("2026E采用约13%的Non-GAAP税率；2027-28包含阶段性权证摊薄。"),
        h2("毛利率的会计分叉"),
        body(
            "若AMD确认更多机架级硬件收入，收入会更高、毛利率可能更低；若以芯片收入为主，收入较低但毛利率更好。本模型将2027毛利率控制在55.5%，没有同时假设“完整机架收入”和“纯芯片毛利率”。"
        ),
        h2("权证与战略投资"),
        table(
            [
            ...
            [1.1 * inch, 1.05 * inch, 2.35 * inch, 1.93 * inch],
            font=6.9,
        ),
        callout(
            "经济摊薄上限",
            "两项权证合计最高3.2亿股，约相当于当前基础股数的19.6%。即使会计EPS短期尚未体现，估值也不能忽略其条件性经济成本。",
            colors.HexColor("#FCEBED"),
            RED,
        ),
        h2("现金流判断"),
        body(
            "AMD资本开支强度较低，盈利可转化为较强自由现金流；但系统放量会提高存货、应收和客户融资需求。50亿美元战略投资、NeoCloud支持及潜在回购会限制现金余额的机械累积。"
        ),
        PageBreak(),
    ]
    ...
    # Page 7
    st += [
        h1("6. 软件生态：迁移成本下降，不等于CUDA壁垒消失"),
        body(
            "ROCm.AI与Coding Agent可以帮助代码转换、算子适配和性能调优，降低首次迁移的人力成本。但生产系统由全生命周期TCO决定，不能只看示范代码是否运行。"
        ),
        table(
            [
                ["层面", "ROCm改善方向", "尚待验证"],
            ...
            [1.2 * inch, 2.35 * inch, 2.88 * inch],
            font=7.4,
        ),
        h2("应使用的验证指标"),
        body(
            "建议每季跟踪四类硬指标：生产客户数量与规模、集群利用率和稳定性、主流模型性能/美元、从CUDA迁移到ROCm的实际工程周期。只有这些指标连续改善，软件生态才会转化为可持续份额。"
        ),
        callout(
            "研究结论",
            "把ROCm视为份额扩张的必要条件，而不是充分条件。客户合同证明AMD已进入采购池，生产效率决定其能否留在核心池。",
        ),
        h2("ROCm对估值的正确映射"),
        table(
            [
    ...
    st += [
        ...
        table(
            ...
            [0.72 * inch, 1.02 * inch, 0.86 * inch, 0.73 * inch, 0.85 * inch, 2.25 * inch],
            font=6.8,
        ),
        callout(
            "评级与目标",
            "中性 / 观察；基准合理价值465美元，合理区间430-530美元。相较当前484.64美元缺乏足够安全边际，等待Q2业绩、MI450首批收入与摊薄细节验证。",
            colors.HexColor("#FFF7E6"),
            GOLD,
        ),
        h2("为什么不使用640美元作为基准"),
        body(
            "640美元基本等于18.28美元2027E EPS乘35倍。数学没有问题，但把接近乐观情景的盈利包装为基准。若采用14.1美元基准EPS，即使给35倍，价值也只有约494美元。核心争议是盈利兑现，而不是2-3倍PE差异。"
        ),
        h2("估值上修条件"),
        body(
            "<b>收入：</b>2026Q3-Q4数据中心收入持续高于基准，且披露2027可交付订单。<br/><b>利润：</b>系统收入放量后Non-GAAP毛利率仍稳定在55%以上。<br/><b>每股：</b>权证归属慢于利润增长，战略投资不侵蚀自由现金流。<br/><b>生态：</b>ROCm生产客户和大规模集群利用率出现量化改善。"
        ),
        PageBreak(),
    ]
    ...
    st += [
        ...
        table(
            ...
            [1.1 * inch, 1.75 * inch, 1.8 * inch, 1.78 * inch],
            font=7.0,
        ),
        h2("主要风险排序"),
        body(
            "<font color='#B23A48'><b>高｜交付与确认。</b></font>GW合作为多年期框架，系统建设、供电、融资和验收均可能推迟收入。"
        ),
        body(
            "<font color='#B23A48'><b>高｜客户与权证集中。</b></font>少数客户决定大部分增量，同时可能触发显著股本摊薄。"
        ),
        body(
            "<font color='#B23A48'><b>高｜软件与利用率。</b></font>峰值性能不等于生产TCO；ROCm稳定性不足会影响复购。"
        ),
        body(
            "<font color='#D69E2E'><b>中高｜毛利率。</b></font>完整机架收入可能稀释毛利率，定制产品也可能让利。"
        ),
        body(
            "<font color='#D69E2E'><b>中高｜供应链。</b></font>HBM、先进封装、互联、液冷与机架集成均可能成为瓶颈。"
        ),
        body(
            "<font color='#D69E2E'><b>中｜竞争与政策。</b></font>英伟达年度迭代、ASIC、Arm CPU与出口管制可能压缩份额。"
        ),
        h2("投委会检查清单"),
        table(
            [
    ...
    st += [
        ...
        h2("主要数据口径"),
        body(
            "本报告以AMD 2025财年实际数据、2026Q1实际和2026Q2公司指引为历史锚。2026-2028年均为研究情景，不是公司指引。Non-GAAP指标用于跨期经营比较；估值同时考虑潜在权证摊薄，不把最高权证股数机械视为必然归属。"
        ),
        h2("主要公开来源"),
        body(
            "1. AMD Reports First Quarter 2026 Financial Results，2026-05-05。<br/>2. AMD and OpenAI Announce Strategic Partnership to Deploy 6 Gigawatts，2025-10-06。<br/>3. AMD and Meta Announce Expanded Strategic Partnership to Deploy 6 Gigawatts，2026-02-24。<br/>4. AMD and Anthropic Announce Strategic Partnership to Deploy Up to 2 Gigawatts，2026-07-22。<br/>5. AMD Advancing AI 2026 Keynote及产品路线图，2026-07-23。<br/>6. AMD 2025 Form 10-K与2026Q1财务报告。<br/>7. UBS, Revisiting AMD and ARM Estimates Amid Agentic AI Acceleration，2026-06-24。<br/>8. 华泰证券，《软硬生态全面进击，剑指Agentic AI算力变局》，2026-07-26。<br/>9. 公开市场价格数据，截至2026-08-04 00:15 UTC。"
        ),
        h2("关键网址"),
        P(
            "https://www.amd.com/en/newsroom/press-releases/2026-5-5-amd-reports-first-quarter-2026-financial-results.html<br/>https://www.amd.com/en/newsroom/press-releases/2025-10-6-amd-and-openai-announce-strategic-partnership-to-d.html<br/>https://www.amd.com/en/newsroom/press-releases/2026-2-24-amd-and-meta-announce-expanded-strategic-partnersh.html<br/>https://ir.amd.com/news-events/press-releases/detail/1292/amd-and-anthropic-announce-strategic-partnership-to-deploy-up-to-2-gigawatts-of-amd-instinct-mi450-series-gpus<br/>https://www.amd.com/en/corporate/events/advancing-ai.html",
            S["small"],
        ),
        h2("免责声明"),
        body(
            "本报告仅用于研究讨论，不构成任何证券买卖建议、要约或保证。预测高度依赖产品交付、客户部署、会计确认、竞争和市场条件，实际结果可能显著不同。报告使用的公开信息被认为可靠，但不保证完整或无误。投资者应结合自身风险承受能力独立判断。"
        ),
        Spacer(1, 0.35 * inch),
        callout(
            "版本识别",
            "本文件为Codex独立研报，文件名含“Codex独立研报”；与Claude生成的 AMD_2026Q2_20260804.md 明确区分。",
            LIGHT,
            BLUE,
        ),
    ]
