...
_HEADERS = {"User-Agent": "ir-agent research tool contact@example.com"}
...
def _cik_for_symbol(symbol: str) -> int | None:
    cache = ROOT / "data/raw/announcements/edgar/_company_tickers.json"
...
def fetch_announcements_us(ticker: str, company_name: str, limit: int = 20) -> dict:
    ...
    raw_dir = ROOT / "data/raw/announcements/edgar"
    processed_dir = ROOT / f"data/processed/announcements/edgar/{ticker}"
