...
RAW_DIR = _SETTINGS.external_source_root / "acecamp_official"
RAW_DIR.mkdir(parents=True, exist_ok=True)
SEARCH_DATA_SOURCE = "acecamp_search_result"
ASK_DATA_SOURCE = "acecamp_ai_answer"

_CONFIG_PATH = get_settings().config_root / "acecamp.json"


def _client():
    from alphasonar.connectors.acecamp.acecamp_client import AceCampClient
...
def _chunk_and_store(text: str, metadata: dict[str, Any]):
    ...
    from alphasonar.storage.vector_store import replace_source_chunks
