...
"""
from alphasonar.agents import researcher, risk, strategy, trader, pm
...
def run(
    ...
    from alphasonar.capabilities import skill2_calculator, skill3_graph_propagator
    ...
    vocab_path = get_settings().vocab_path
    ...
    # ── 拼装完整报告 ──────────────────────────────────────────────────────
    return f"""# 🏦 AlphaSonar 多 Agent 投研报告 · {company_name}（{ticker}）· {period}
