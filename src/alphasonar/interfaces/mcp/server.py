...
from alphasonar.agents import orchestrator
from alphasonar.capabilities import (
    skill1_text2sql,
    skill2_calculator,
...
app = Server("alpha-mcp", instructions=_INSTRUCTIONS)
...
async def list_tools() -> list[Tool]:
    return [
        ...
        Tool(
            ...
            description="调用多源对抗互证器，生成完整的 AlphaSonar 辩证投研 Markdown 报告。",
            inputSchema={
                "type": "object",
                "properties": {
                    "ticker": {"type": "string"},
...
async def call_tool(name: str, arguments: dict) -> list[TextContent]:
    ...
    if name == "adversarial_report":
        ...
        from alphasonar.storage.vector_store import latest_by_source
        from alphasonar.storage.vector_store import search as vector_search
